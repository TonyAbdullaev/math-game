...
const questionGenerator = () => {
    ...
    //(1 for num1, 2 for num2, 3 for operator, anything else for solution
    ...
    submitBtn.addEventListener("click", () => {
        ...
        // if User input isn't empty
        if (userInput) {
            //If user guessed correct answer, == because we have operators too
            if (userInput == answerValue) {
                stopGame(`Yep! <span>Correct</span> Answer`);
            }
            // IF user inputs operator other than in operators
